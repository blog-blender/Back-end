...
from .views import postList, postDetail,commentListView,homeView,RecentPosts,CreatePost,CommentUpdateView,PostUpdateView,commentCreateView,UpdatePost
...
urlpatterns = [
    ...
    path('<int:post_id>/update/',UpdatePost, name='post-update'),

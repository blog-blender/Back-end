...
from .views import postList, postDetail,commentListView,homeView,RecentPosts,CreatePost,CommentUpdateView,commentCreateView,UpdatePost,CreateLike,DeleteLike,Deletepost
...
urlpatterns = [
    ...
    path("like/delete/<int:like_id>/",DeleteLike.as_view(),name="delete_like"),
